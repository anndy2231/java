...
<script type="text/javaScript" language="javascript" defer="defer">
	function signup(){
		...
		var url = "<c:url value='/signup_action.do'/>";
		$.ajax({
			  url: url,
			  processData: false,
			  contentType: false,
					...
					<div class="card bg-light text-dark" style="min-height: 500px; max-height: 1000px">
						<form id="form1" name="form1">
							<div class="form-group">
								...
								<div>
									<input class="form-control" rows="10" id="name" placeholder="이름을 입력하세요"></input>
								</div>
							</div>
						...
						<div style="text-align: center">
							<div class="btn-group">
								<button type="button" class="btn btn-primary" onclick="signup()">가입</button>
