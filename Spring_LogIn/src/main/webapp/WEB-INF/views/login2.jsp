...
<body>
	<section class="wrap">
		<h2 style="text-align:center;">개인정보 변경을 위하여 로그인이 필요합니다.</h2>
		<form action="login_action2" method="post">
			...
			<div class="join">
			<a href="/spring_login_0601/insert">회원 가입</a>
			</div>
			<div>
			<a href="/spring_login_0601/">홈으로</a>
			</div>
		</form>
	</section>
</body>
